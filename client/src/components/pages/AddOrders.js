                        ...
                        <Stack spacing={3}>
                            <div>
                                ...
                                <TextField className="input" value={nameInput} size="small" style={{ width: " 285px" }}
                                    ...
                                    label="Nume client" variant="outlined">
                                </TextField>
                            </div>
                            <div>
                            ...
                            <div>
                                <FactCheckIcon className='form-icon' fontSize='large' />
                                <FormControl style={{minWidth: 220}}>
                                <InputLabel id="demo-simple-select-label">Status comanda</InputLabel>
                                <Select id="demo-simple-select" label="Produsul comandat"
                                    onChange={event => setStatus(event.target.value)} defaultValue="">
                                 <MenuItem key={nr++} value="initiata">initiata</MenuItem>
                                 <MenuItem key={nr++} value="preluata">preluata</MenuItem>
                                 <MenuItem key={nr++} value="preparata">preparata</MenuItem>
                                 <MenuItem key={nr++} value="ridicata">ridicata</MenuItem>
                                </Select>
                                </FormControl>
                                </div>
                                <div>
