...
function onReset() {
    ...
    return ( 
        ...
        <Typography variant="h4" color="primary" style={{paddingBottom:'5%'}}>Achizitioneaza ingrediente</Typography>
            ...
            <Grid id="form">
                ...
                {/* <div>
                <img src="/images/agreement.svg" height="500em" style={{ maxWidth:'85%',  paddingRight:'5%'}}></img>
                </div> */}
            </Grid>
        </FormGroup>
